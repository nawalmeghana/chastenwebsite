        ...
        <div class="container">
          <div class="py-5">
            ...
            <div class="row">
                ...
                <div class="contact-form">
                  <form id="contactForm" method="POST"
                    ...
                    <div class="mb-3">
                      ...
                      <textarea name="Requirements" class="form-control" id="requirementsInput" rows="4" required></textarea>
                    </div>
              ...
              <div class="col-md-6 contact-info fade-in">
                <div class="footer-item">
                  ...
                  <div>
                    <a href="https://maps.app.goo.gl/m55JmXxTUM46Z5XQ6">
            ...
            <div class="copyright text-center">
              <p>© 2024 Chasten Rubber Product. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
